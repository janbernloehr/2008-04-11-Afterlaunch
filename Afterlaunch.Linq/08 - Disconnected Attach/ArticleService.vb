...
#End Region
  ...
  Public Function GetArticleById(ByVal articleId As Integer) As Article
    ' Abfrage formulieren
    Dim articles = From x In GetContext.Articles _
                   Where x.Id = articleId
  ...
  ''' <summary>
  ''' Geänderten Artikel anfügen
  ''' </summary>
  Public Sub UpdateArticle(ByVal article As Article, ByVal original As Article)
    GetContext.Articles.Attach(article, original)
  End Sub
