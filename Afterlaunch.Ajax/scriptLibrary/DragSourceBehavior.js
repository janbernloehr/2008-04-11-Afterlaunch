//
Custom.UI.BookDragSourceBehavior = function(element, bookId)
{
    Custom.UI.BookDragSourceBehavior.initializeBase(this, [element]);
...
Custom.UI.BookDragSourceBehavior.prototype =
{
    // IDragSource methods
    ...
    initialize: function()
    {
        Custom.UI.BookDragSourceBehavior.callBaseMethod(this,
            'initialize');
    ...
    mouseDownHandler: function(ev)
    {
        ...
        Sys.Preview.UI.Effects.Glitz.setElementOpacity(this._visual, 0.4);
...
Custom.UI.BookDragSourceBehavior.registerClass
    ('Custom.UI.BookDragSourceBehavior', Sys.UI.Behavior,
    Sys.Preview.UI.IDragSource);


Custom.UI.BookDropTargetBehavior = function(element)
{
    Custom.UI.BookDropTargetBehavior.initializeBase(this, [element]);
    this._color = null;
}
    
Custom.UI.BookDropTargetBehavior.prototype =
{
    // IDropTarget methods
    ...
    {
        return (dataType == 'DragDropBook' && data);
    },
    ...
    initialize: function()
    {
        Custom.UI.BookDropTargetBehavior.callBaseMethod(this,
            'initialize');
...
Custom.UI.BookDropTargetBehavior.registerClass
    ('Custom.UI.BookDropTargetBehavior', Sys.UI.Behavior,
